...
public class TicTacToe {
    ...
    public static int checkAvailableSlotsColumn(int r)
    {
        int available =0;
    ...
    public static int checkAvailableSlotsrow(int c)
    {
        int available =0;
    ...
    public static int[] checkAvailableSlotsDiagonal()
    {
        int ltoR =0;
        int rtoL=0;
        ...
        return new int[]{ltoR,rtoL,ltoR+rtoL};
    }
